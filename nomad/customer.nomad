// customer.nomad - Job for the customer activity service
...
// Specific parameters for the customer activity service
locals {
  service_name = "customer-activity-service"
  service_port = 3005
  docker_image = "microservices-architecture/customer-activity-service:${var.image_tag}"
...
variable "count" {
  type    = number
  default = 2  // Two instances of the customer activity service
}
